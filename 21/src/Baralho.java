...
public class Baralho {
    ...
    // Classe estática para representar cada carta
    static class Carta {
        private String nome;
        private int valor;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Cartas do baralho (do início ao fim):");
        baralho.exibirBaralho();

        System.out.println("\nTotal de cartas: " + baralho.tamanho());

        System.out.println("\nCartas do baralho em ordem inversa (do fim para o início):");
        baralho.exibirBaralhoReverso();

        // Demonstrando a remoção de cartas
        System.out.println("\nRemovendo a primeira carta: " + baralho.removerPrimeira());
        System.out.println("Removendo a última carta: " + baralho.removerUltima());
        System.out.println("Total de cartas após remoções: " + baralho.tamanho());
    }
}